...
The goal of regexcite.nd is to make regular expressions more exciting!
It provides convenience functions to make some common tasks with string
manipulation and regular expressions a bit easier.

## Installation

You can install the development version of regexcite.nd from
[GitHub](https://github.com/) with:

``` r
# install.packages("devtools")
devtools::install_github("nd265/regexcite.nd")
```
...
That’s exactly what `regexcite.nd::str_split_one()` does.

``` r
library(regexcite.nd)
